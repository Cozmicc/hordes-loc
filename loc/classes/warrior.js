export default {
  ...
  description: {
    ...
    se: 'Krigare är byggda för att tåla mer skada än alla andra klasser genom högt försvar från sin utrustning (Sköld) och starka försvars Buffar.',
    ...
    es: 'Soldados son los tanques de la guerra, soldados luchan para el honor y gloria de la batalla. Ellos pueden aguantar en un gran cantidad de daño con sus escudos y buffs de defensa.',
